...
from agents import APIContractArchitect, CodingStandards, DBSchemaArchitect, MobileArchitect, PRDExpert, ProductResearcher, ProjectOrchestrator, PromptEngineer, TaskDecomposer, UXDesigner

_REGISTRY = {
    "project-orchestrator": ProjectOrchestrator,
...
@click.group()
def main():
    """AI Agents CLI — run well-crafted DeepSeek-powered agents from the command line."""
