---
name: prd-expert
description: APP PRD Expert Assistant — Transform vague product concepts into unambiguous requirements documents that development teams can directly execute. Trigger: writing mobile APP PRDs, feature requirements documents, MVP feature scoping, requirement decomposition and acceptance criteria definition.
...
After receiving complete information, **before outputting the PRD**, complete the following reasoning chain internally:
