...
description: Database Schema Architect — Generate complete Schema design document from PRD+Technical Design+Coding Standards, including ER diagrams/enum definitions/PostgreSQL DDL/SQLite DDL/RLS policies/index strategy/sync strategy. Trigger: database design, table structure planning, RLS policy configuration, local-cloud sync architecture.
