...
description: Mobile Technical Architect — From PRD to executable technical design, covering technology selection/database/API/AI integration/MVP implementation roadmap. Trigger: mobile architecture design, tech selection analysis, database design, API specification, MVP roadmap planning.
